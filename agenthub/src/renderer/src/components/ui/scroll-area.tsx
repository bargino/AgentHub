  ...
  return (
    ...
    >
      <ScrollAreaPrimitive.Viewport
        ...
        className="focus-visible:ring-ring/40 size-full rounded-[inherit] transition-[color,box-shadow] outline-none focus-visible:ring-[3px] focus-visible:outline-1"
      >
        {children}
      </ScrollAreaPrimitive.Viewport>
      <ScrollBar />
